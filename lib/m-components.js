      ...
      $.ajax({
        ...
        success: function success(data, status, xhr) {
          if (typeof _this2.options.judger !== 'function' || _this2.options.judger(data)) {
            var path = _this2.options.urlField.split('.');
            var url = '';
