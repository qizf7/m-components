...
var Calendar = function () {
  ...
  _createClass(Calendar, [{
    ...
    value: function handleConfirm() {
      this.calendarDom.find('.' + prefix + '-text').val(this.selectedDate.format('YYYY-MM-DD') + ' ' + this.selectedTime.format('HH:mm'));
