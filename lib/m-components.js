  ...
  _createClass(ImageUploader, [{
    ...
    value: function renderThumbnail() {
      ...
      this.itemDoms = this.fileList.map(function (upFileObject, index) {
        ...
        // todo
        containerDom.on('click', 'img', function () {
    ...
    value: function handleInputChange(e) {
      ...
      if (file) {
        this.readThumbnail(file).then(function (data) {
          ...
          _this2.uploadFile(upFileObject, _this2.fileList.length - 1);
        });
      }
    }
  }, {
      ...
      $.ajax({
        ...
        success: function success(data, status, xhr) {
          if (typeof _this3.options.judger !== 'function' || _this3.options.judger(data)) {
            upFileObject.url = data[_this3.options.urlField];
            handleUploadSuccess();
          } else {
            handleUploadFail();
          }
